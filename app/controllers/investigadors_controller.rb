  ...
  def create
    ...
    respond_to do |format|
      if @investigador.save
        format.html { redirect_to investigador_url(@investigador), notice: "Investigador was successfully created." }
  ...
  def update
    respond_to do |format|
      if @investigador.update(investigador_params)
        format.html { redirect_to investigador_url(@investigador), notice: "Investigador was successfully updated." }
